...
from models.model_pretrain import ALBEF_pre
...
def main(args, config,config_pretrain):
    ...
    pretrain_model = ALBEF_pre(config=config_pretrain, text_encoder=args.text_encoder, tokenizer=tokenizer,
                               init_deit=True)
    pretrain_model = pretrain_model.to(device)
    pgd_attack = Adv_attack(model, pretrain_model, tokenizer, device, config_pretrain)
