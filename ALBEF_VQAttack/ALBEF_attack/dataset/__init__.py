...
def create_dataset(dataset, config):
    ...
    if dataset=='pretrain':
        ...
        # train_dataset = vqa_dataset(config['train_file'], train_transform, config['vqa_root'],
        #                             split='train')
        # vqa_test_dataset = vqa_dataset(config['test_file'], test_transform, config['vqa_root'],
