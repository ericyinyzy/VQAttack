...
def compute_vqa(pl_module, batch):
    ...
    ret = {
        "feats_list": infer['feats'],
        "text_masks": infer["text_masks"],
        "vqa_loss": vqa_loss,
...
def vqa_test_step_after_pgd(pl_module, logits):
    # id2answer = (
    ...
    fr = open('id2answer.txt', 'rb')
    id2answer = pickle.load(fr)
    ...
    # qids = batch["qid"]
    # print('vqa_preds',vqa_preds)
    # exit()
    return {"qids": None, "preds": vqa_preds}
